...
> **🔒 Security Update**: このプロジェクトは Next.js 15.5.10 を使用しており、**Remote Code Execution (RCE) を含むすべての重大な脆弱性**が修正されています。詳細は [SECURITY_ADVISORY.md](docs/SECURITY_ADVISORY.md) を参照してください。
